...
export default function page() {
    return (
        <main>
            <header>
                <h1 className='h1_class'>Aryna Sabalenka</h1>
                <div className='header-image'>
                    <img
                        src="/as/sabalenka.jpg"
                        className='div_img'
                    />
                </div>
            </header>
            ...
            <section className='section'>
                <h2 className='h2_class'>Aryna Siarhiejeŭna Sabalenka</h2>
                <p>(born 5 May 1998) is a Belarusian professional tennis player. She is currently the world No. 1 in women's singles by the WTA, and is a former world No. 1 in doubles. Sabalenka has won 21 WTA Tour-level singles titles, including four majors - two each at the Australian Open and the US Open - as well as nine WTA 1000 events. She has also won six doubles titles, including the 2019 US Open and 2021 Australian Open, both partnering Elise Mertens
                </p>
