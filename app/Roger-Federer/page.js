...
export default function page() {
    return (
        <main>
            <header>
                <h1 className='h1_class'>Roger Federer</h1>
                <div className='header-image'>
                    <img
                        src="/rf/geschafft-roger-federer-holt.jpg"
                        className='div_img'
                    />
                </div>
            </header>
