...
export default function page() {
    return (
        <main>
            <header>
                <h1 className='h1_class'>Anthony Davis</h1>
                <div className='header-image'>
                    <img
                        src="/ad/anthony-davis-081318-ftr-getty_ht13e0hgo9bo1j4fw952ejd92.jpg"
                        className='div_img'
                    />
                </div>
            </header>
