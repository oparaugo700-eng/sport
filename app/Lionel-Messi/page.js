...
export default function page() {
    return (
        <main>
            <header>
                <h1 className='h1_class'>Lionel Messi</h1>
                <div className='header-image'>
                    <img
                        src="/lm/gettyimages-2239259233-612x612-1.jpg"
                        className='div_img'
                    />
                </div>
            </header>
            ...
            <aside className='main_aside'>
                <div className='aside_div'>
                    ...
                    <p><span>In full:</span> Lionel Andrés Messi</p>
                    <p><span>Also called:</span> Leo Messi</p>
                    <p><span>Born:</span> June 24, 1987, Rosario, Argentina (age 38)</p>
                    <p><span>Awards And Honors:</span> Olympic Games Presidential Medal of Freedom (2025) World Cup (2022)</p>
                </div>
            </aside>

            <section className='section'>
                <h3 className='h3_class'>Early life </h3>
